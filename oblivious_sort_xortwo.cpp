#include "oblivious_sort_xortwo.h"
#include <iostream>
#include <algorithm>
#include <random>
#include <cstring>
...
// XOR-based encryption: for each non-dummy element, XOR the sorting and key fields,
// and XOR each character of the payload.
...
// Since XOR is symmetric, decryption is identical.
